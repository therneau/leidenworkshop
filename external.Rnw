...
what the what the paper predicted (y given x), 
or a backwars in time view and ask how often the paper guessed correctly 
...
for (i in 1:151) {
    ...
    c3 <- concordance(temp~ eta1, data=gbsg2, weight=reweight[,i],
                      subset=(reweight[,i] > 0))
    c4 <- concordance(rfit1, ymax=tau2[i]) # concordance of the training data
